...
class ReactivoController extends Controller
{
     ...
     * @Method("POST")
     * @Template("AppBundle:Reactivo:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('reactivo_show', array('id' => $entity->getId())));
        }
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Reactivo:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('reactivo_edit', array('id' => $id)));
        }
